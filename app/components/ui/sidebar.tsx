  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 ash-[calc(100vh-56px)] h-auto mt-[56px] ",
        className
      )}
      {...props}
    />
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      ...
      className={cn("group/menu-sub-item relative flex items-center rounded-sm", className)}
      {...props}
    />
  )
}
