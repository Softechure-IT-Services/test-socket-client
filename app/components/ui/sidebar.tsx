    ...
    <SidebarSideContext.Provider value={side}>
      ...
      >
        ...
        <div
          ...
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex h-[calc(100%-40px)] sm:h-[calc(100%-56px)] bottom-0 top-[unset]",
            side === "left"
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background z-[9] relative flex w-full flex-1 flex-col overflow-auto",
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 h-[calc(100vh-80px)] sm:h-[calc(100vh-56px)] mt-0 pt-[40px] ",
        className
      )}
      {...props}
    />
